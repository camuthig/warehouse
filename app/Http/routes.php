...
Products routes
 */
$app->group(['prefix' => 'api/orders'], function () use ($app){
    $app->get('/', ['as' => 'orders', 'uses' => 'App\Http\Controllers\OrderController@index']);
    $app->post('/', ['as' => 'orders_create', 'uses' => 'App\Http\Controllers\OrderController@create']);
});